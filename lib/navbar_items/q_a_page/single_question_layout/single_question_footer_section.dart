 ...
 Future<List<Comment>> getPostComments(){
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle postInfoTextStyle = TextStyle(
      fontFamily: "Mina",
      letterSpacing: 0,
      fontSize: 14/widthMultiplier,fontWeight: FontWeight.w700,color:   Color(0xff3A7F0D),);
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 3,),
                            Text(comment.likes.length.toString(),style: TextStyle(color: Color(0xff3A7F0D),fontSize: 10,fontFamily: "Mina",fontWeight: FontWeight.w700),),
                            SizedBox(width: 50,),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Icon(comment.dislikes.contains(sharedObjectsGlobal.userGlobal.phone_number)?FontAwesomeIcons.solidThumbsDown:FontAwesomeIcons.thumbsDown,
                                color:comment.dislikes.contains(sharedObjectsGlobal.userGlobal.phone_number)? Colors.red: Colors.grey,
                              ),
                            ),
                            SizedBox(width: 3,),
