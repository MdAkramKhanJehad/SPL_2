...
class _SingleQuestionMiddleState extends State<SingleQuestionMiddle> {
  ...
  Future<AppUser> getPostOwnerInfo()async{
    return FirebaseFirestore.instance.collection('users').doc(widget.question.userId).get().then((doc){
      AppUser postOwner = AppUser.fromJson(doc);
      return postOwner;
    });
  }
  @override
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle postInfoTextStyle = TextStyle(
      fontFamily: "Mina",
      letterSpacing: 0,
      fontSize: 14/widthMultiplier,fontWeight: FontWeight.w800,color:   sharedObjectsGlobal.educationGreen,);

    return FutureBuilder(
      future: getPostOwnerInfo(),
      builder: (context,snapshot){
        if(snapshot.hasData){
          AppUser postOwner = snapshot.data as AppUser;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(postOwner.user_name,textAlign: TextAlign.left,style: postInfoTextStyle),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 3,),
                      Text(widget.question.likes.length.toString(),style: TextStyle(color: sharedObjectsGlobal.educationGreen,fontSize: 10,fontFamily: "Mina",fontWeight: FontWeight.w700),),
                      SizedBox(width: 50,),
                      GestureDetector(
                          onTap: (){
                           if(sharedObjectsGlobal.userSignIn){
                             tapDislikeLoggedUser();
                           }
                      ...
                      GestureDetector(
                          ...
                          child: Icon(FontAwesomeIcons.commentAlt,color:sharedObjectsGlobal.userSignIn ? Color(0xff38A1F4):Colors.grey,)),
                      SizedBox(width: 3,),
                      Text(widget.question.numberOfComments.toString(),
                        style: TextStyle(color: Color(0xff38A1F4),fontSize: 10,fontFamily: "Mina",fontWeight: FontWeight.w700),
                      ),
                    ],
                  ),
                ],
